...
public class SmileDemoEDA {
    String trainPath = "/Users/saraelaraby/Documents/ITI-AI/JavaProjects/untitled/src/main/resources/titanic_train.csv";
    String testPath = "/Users/saraelaraby/Documents/ITI-AI/JavaProjects/untitled/src/main/resources/titanic_test.csv";
    ...
    public static void main(String[] args) throws IOException {
        ...
        DataFrame testData = pProvider.readTestData (sd.testPath);
        ...
        RandomForest modelTestData = RandomForest.fit(Formula.lhs("Class"), testData);
        System.out.println("================ feature importance ===============");
        System.out.println(Arrays.toString(modelTestData.importance()));
        System.out.println(modelTestData.metrics ());
